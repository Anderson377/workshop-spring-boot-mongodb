package com.andersondolce.workshopmongo.config;

import com.andersondolce.workshopmongo.domain.Post;
import com.andersondolce.workshopmongo.domain.User;
import com.andersondolce.workshopmongo.dto.AuthorDTO;
import com.andersondolce.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c3 = new CommentDTO("Tenha um otimo ida", sdf.parse("23/03/2018"),new AuthorDTO(alex));
